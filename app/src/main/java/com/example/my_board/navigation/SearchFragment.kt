...
import kotlinx.android.synthetic.main.main_detail.view.board_listview
import kotlinx.android.synthetic.main.search.view.*


class SearchFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var view = LayoutInflater.from(activity).inflate(R.layout.search, container, false)
        ...
        view.TextInputEditText_search.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(edit: Editable) {
                val filterText = edit.toString()
                (view.board_listview.getAdapter() as ListViewAdapter).filter.filter(filterText)
            }
